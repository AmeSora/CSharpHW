...
namespace OrderUI
{
    public partial class Form1 : Form
    {
        ...
        private void dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            dataGridView2.DataSource = order.Details.Select(o => new { o.Amount, o.Quantity,
                g_id = o.Goods.Id, g_name = o.Goods.Name, g_price = o.Goods.Price }).ToList();
        }
        ...
        {
            var list = orderService.orderList.Select(o => new {
                o.Id,
                o.TotalAmount,
                c_id = o.Customer.Id,
                c_Name = o.Customer.Name
